...
var='sensible'; vars='SHTFL';
taux=taux+ncread([src,'NCEP2_daily_',var,'.nc'],vars);
var='swrad_up'; vars='USWRF_SURF';
taux=taux+ncread([src,'NCEP2_daily_',var,'.nc'],vars);
var='lwrad_up'; vars='ULWRF_SURF';
taux=taux+ncread([src,'NCEP2_daily_',var,'.nc'],vars);
var='swrad_dn'; vars='DSWRF_SURF';
taux=taux-ncread([src,'NCEP2_daily_',var,'.nc'],vars);
var='lwrad_dn'; vars='DLWRF';
taux=taux-ncread([src,'NCEP2_daily_',var,'.nc'],vars);
var='Qnet';
